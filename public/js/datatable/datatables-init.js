var DetailInitiateSimpleDataTable = function () {
    return {
        init: function () {
...
var InitiateSimpleDataTable = function () {
    return {
        init: function () {
            ...
            //Check All Functionality
            jQuery('#simpledatatable1 .group-checkable').change(function () {
                var set = $(".checkboxes");
                var checked = jQuery(this).is(":checked");
                jQuery(set).each(function () {
                    if (checked) {
            ...
            jQuery('#simpledatatable1 tbody tr .checkboxes').change(function () {
                $(this).parents('tr').toggleClass("active");
            });
